...
* ✅ **7c.1-7c.4 — Concursos Hub** (2026-08-16): `/concursos` evoluiu pra Central de Preparação (busca, abas abertos/andamento/encerrados, disciplinas, simulados, videoaulas, meu desempenho, cadastro admin) — projeto completo em [CONCURSOS_HUB.md](CONCURSOS_HUB.md). ⏳ 7c.5 (popular com concursos reais) e 7d/7e (dados.gov.br, RAG+edital) pendentes.
