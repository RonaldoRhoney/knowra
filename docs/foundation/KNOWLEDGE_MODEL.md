...
**Diretriz confirmada pelo Ronaldo (2026-08-15)**: o módulo de Concursos Públicos (Fase 7) deve se basear em **APIs públicas legalmente disponíveis** para fornecimento de questões — nunca scraping de provas/gabaritos protegidos por direito autoral nem cópia de banco de questões de terceiros sem licença. Antes de integrar qualquer provedor real nessa fase, verificar explicitamente: a API é pública/oficial (ex: dados abertos de bancas/órgãos), tem termos de uso compatíveis com uso comercial do KnowRa, e permite armazenamento (não só exibição ao vivo). Questões originais geradas pela IA continuam sendo a alternativa seguro-por-padrão quando não houver uma fonte pública clara — sempre marcadas como conteúdo gerado, nunca como oficial (ver [AI_ENGINE.md](AI_ENGINE.md)).
